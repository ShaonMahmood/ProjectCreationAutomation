...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.project_directory_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.project_directory_text.setGeometry(QtCore.QRect(330, 330, 201, 41))
        self.project_directory_text.setPlainText("")
        ...
        self.project_name_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        ...
        self.venv_text = QtWidgets.QPlainTextEdit(self.centralwidget)
